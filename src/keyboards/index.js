...
export const brandsKeyboard = brands.reduce(
...
export const sexKeyboard = sexes.reduce(
  (result, { label, data }) => result.text(label, data).row(),
  new InlineKeyboard()
)
...
export const confirmKeyboard = new InlineKeyboard().text(
  'Подтвердить',
  'confirm'
)
...
export const contactKeyboard = new InlineKeyboard().url(
  'Купить',
  'https://t.me/temchik05'
)
